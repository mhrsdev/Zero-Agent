...
- V1→V3 migration: partial; `long_term_memory` and `medium_term_memory` map directly
...
- Remaining approved tables are not mapped; source/target reporting is still incomplete.
