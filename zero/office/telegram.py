...
class TelegramOfficeBridge:
    ...
    def __init__(self, config: OfficeConfig, intake: OfficeIntakeService, *, bot_username: str, account_scope: str = "telegram", installation_id: str = "inst-test", group_id: str = "group-test"):
    ...
    async def handle_event(self, event) -> bool:
        ...
        request = OfficeRequest(
            ...
            installation_id=self.installation_id, group_id=self.group_id,
